# nvim-treesitter-queries-mlir

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-mlir/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-mlir/actions/workflows/validate.yml)

Neovim tree-sitter queries for **mlir**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-mlir",
...
- [ ] Changes are scoped to `mlir` — do not include files for other languages
